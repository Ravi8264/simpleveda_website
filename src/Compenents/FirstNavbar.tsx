...
import LoginModal from "../pages/models/LoginModel";
import RegisterModal from "../pages/models/RegisterModel";
          ...
          <div className="desktop-view">
            ...
            {!isLoggedIn ? (
              <div className="auth-actions">
                ...
                >
                  <LockClosedIcon className="icon icon-maroon" />
                  <span className="action-text text-maroon">
                    Login
                  </span>
                </div>
                ...
                >
                  <KeyIcon className="icon icon-gray" />
                  <span className="action-text text-gray">
                    Register
                  </span>
                </div>
                ...
                <div className="action-item">
                  <HeartIcon className="icon icon-maroon" />
                  <span className="action-text text-maroon support-text">
                    Support Us
                  </span>
                </div>
              </div>
              ...
              <div className="auth-actions">
                ...
                >
                  <LockOpenIcon className="icon icon-gray" />
                  <span className="action-text text-gray">
                    Logout
                  </span>
                </div>
